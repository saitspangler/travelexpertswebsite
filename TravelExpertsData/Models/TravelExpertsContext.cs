...
//        => optionsBuilder.UseSqlServer("Server=SAIT228749;Database=TravelExperts;Integrated Security=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PackageProductSupplierId).HasName("PK__Packages__53E8ED997DC4446D");
            ...
            entity.HasIndex(e => new { e.PackageId, e.ProductSupplierId }, "UQ__Packages__29CA8E95080046D0").IsUnique();
